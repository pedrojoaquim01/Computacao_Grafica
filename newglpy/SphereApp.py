...
class SphereApp(GLAPP):
    ...
    def drawSphere(self):
        ...
        if self.sphereArrayBufferId == None:
            ...
            for i in range(0,n):
                ...
                for j in range(0,n):
                    ...
                    textureCoord.append(math.cos(theta)*math.cos(phi))
                    textureCoord.append(math.sin(phi))
                    textureCoord.append(math.sin(theta)*math.cos(phi))
        ...
        GL.glBindVertexArray(self.sphereArrayBufferId)
        GL.glDrawArrays(GL.GL_TRIANGLES,0,600)
        self.a += 0.01
